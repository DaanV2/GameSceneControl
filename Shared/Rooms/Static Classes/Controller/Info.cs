namespace GameSceneControl.Rooms {
    public static partial class Controller {
        ...
        public static RoomInfo GetInfo(String ID) {
            (Boolean ok, RoomInfo info) = DataStorage.Get<RoomInfo>(InfoFileName, Path.Join(RoomFolder, ID));
        ...
        public static List<RoomInfo> GetRooms() {
            String[] files = DataStorage.GetFiles(RoomFolder);
            ...
            foreach (String infoFile in files) {
                ...
                (Boolean ok, RoomInfo info) = DataStorage.Load<RoomInfo>(infoFile);
        ...
        public static Boolean Store(this RoomInfo Info) {
            return DataStorage.Set(InfoFileName, Path.Join(RoomFolder, Info.ID), Info);
        }
    }
}
